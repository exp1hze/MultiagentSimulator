...
set ylabel "Bins"
set zlabel "Count"
set output "run.4.stephistnorth.eps"
set title "Histogram of intensity values, north"
set dgrid3d 50,50 qnorm 2
splot "run.4.stephistnorth" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.4.stephistsouth.eps"
set title "Histogram of intensity values, south"
set dgrid3d 50,50 qnorm 2
splot "run.4.stephistsouth" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.4.stephisteast.eps"
set title "Histogram of intensity values, east"
set dgrid3d 50,50 qnorm 2
splot "run.4.stephisteast" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.4.stephistwest.eps"
set title "Histogram of intensity values, west"
set dgrid3d 50,50 qnorm 2
splot "run.4.stephistwest" using 2:4:6 w lines
unset size
unset title
