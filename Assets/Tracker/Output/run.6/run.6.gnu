...
set ylabel "Bins"
set zlabel "Count"
set output "run.6.stephistnorth.eps"
set title "Histogram of intensity values, north"
set dgrid3d 50,50 qnorm 2
splot "run.6.stephistnorth" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.6.stephistsouth.eps"
set title "Histogram of intensity values, south"
set dgrid3d 50,50 qnorm 2
splot "run.6.stephistsouth" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.6.stephisteast.eps"
set title "Histogram of intensity values, east"
set dgrid3d 50,50 qnorm 2
splot "run.6.stephisteast" using 2:4:6 w lines
unset size
unset title
...
set ylabel "Bins"
set zlabel "Count"
set output "run.6.stephistwest.eps"
set title "Histogram of intensity values, west"
set dgrid3d 50,50 qnorm 2
splot "run.6.stephistwest" using 2:4:6 w lines
unset size
unset title
...
set cbrange[-0.5:4.5]
set view map
plot [][501:-2] "run.6.stepagentaction" matrix w image

set term post eps color
set size ratio 2
set output "run.6.stepthreshnorth.eps"
...
set view map
plot [-20.000000:220.000000][501:-2] "run.6.stepthreshnorth" matrix title "" w image
unset size
unset title
unset xlabel
unset ylabel
...
set term post eps color
set size ratio 2
set output "run.6.stepthreshsouth.eps"
...
set cbrange[0:10.000000]
set view map
plot [-20.000000:220.000000][501:-2] "run.6.stepthreshsouth" matrix title "" w image
unset size
unset title
unset xlabel
unset ylabel
...
set term post eps color
set size ratio 2
set output "run.6.stepthresheast.eps"
...
set cbrange[0:10.000000]
set view map
plot [-20.000000:220.000000][501:-2] "run.6.stepthresheast" matrix title "" w image
unset size
unset title
unset xlabel
unset ylabel
...
set term post eps color
set size ratio 2
set output "run.6.stepthreshwest.eps"
...
set cbrange[0:10.000000]
set view map
plot [-20.000000:220.000000][501:-2] "run.6.stepthreshwest" matrix title "" w image
unset size
unset title
unset xlabel
unset ylabel
...
set output "run.6.threshrangenorth.eps"
set title "Agent threshold ranges: North"
plot "run.6.threshrange" using 2:4:5:6 title "" w errorbars
set output "run.6.threshrangesouth.eps"
set title "Agent threshold ranges: South"
plot "run.6.threshrange" using 2:8:9:10 title "" w errorbars
set output "run.6.threshrangeeast.eps"
set title "Agent threshold ranges: East"
plot "run.6.threshrange" using 2:12:13:14 title "" w errorbars
set output "run.6.threshrangewest.eps"
set title "Agent threshold ranges: West"
plot "run.6.threshrange" using 2:16:17:18 title "" w errorbars
unset size
...
plot [][-28.000000:2828.000000]\
     ...
     "run.6.stepagentactionwtime" using 2:(($103*2)+1400) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($104*2)+1414) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($105*2)+1428) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($106*2)+1442) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($107*2)+1456) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($108*2)+1470) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($109*2)+1484) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($110*2)+1498) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($111*2)+1512) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($112*2)+1526) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($113*2)+1540) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($114*2)+1554) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($115*2)+1568) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($116*2)+1582) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($117*2)+1596) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($118*2)+1610) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($119*2)+1624) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($120*2)+1638) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($121*2)+1652) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($122*2)+1666) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($123*2)+1680) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($124*2)+1694) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($125*2)+1708) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($126*2)+1722) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($127*2)+1736) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($128*2)+1750) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($129*2)+1764) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($130*2)+1778) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($131*2)+1792) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($132*2)+1806) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($133*2)+1820) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($134*2)+1834) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($135*2)+1848) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($136*2)+1862) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($137*2)+1876) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($138*2)+1890) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($139*2)+1904) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($140*2)+1918) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($141*2)+1932) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($142*2)+1946) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($143*2)+1960) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($144*2)+1974) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($145*2)+1988) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($146*2)+2002) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($147*2)+2016) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($148*2)+2030) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($149*2)+2044) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($150*2)+2058) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($151*2)+2072) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($152*2)+2086) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($153*2)+2100) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($154*2)+2114) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($155*2)+2128) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($156*2)+2142) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($157*2)+2156) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($158*2)+2170) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($159*2)+2184) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($160*2)+2198) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($161*2)+2212) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($162*2)+2226) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($163*2)+2240) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($164*2)+2254) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($165*2)+2268) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($166*2)+2282) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($167*2)+2296) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($168*2)+2310) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($169*2)+2324) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($170*2)+2338) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($171*2)+2352) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($172*2)+2366) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($173*2)+2380) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($174*2)+2394) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($175*2)+2408) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($176*2)+2422) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($177*2)+2436) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($178*2)+2450) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($179*2)+2464) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($180*2)+2478) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($181*2)+2492) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($182*2)+2506) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($183*2)+2520) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($184*2)+2534) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($185*2)+2548) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($186*2)+2562) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($187*2)+2576) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($188*2)+2590) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($189*2)+2604) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($190*2)+2618) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($191*2)+2632) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($192*2)+2646) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($193*2)+2660) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($194*2)+2674) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($195*2)+2688) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($196*2)+2702) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($197*2)+2716) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($198*2)+2730) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($199*2)+2744) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($200*2)+2758) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($201*2)+2772) title "" w line lt 1,\
     "run.6.stepagentactionwtime" using 2:(($202*2)+2786) title "" w line lt 1
